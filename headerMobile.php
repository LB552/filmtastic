...
<head>
    ...
    <link rel="stylesheet" href="style_detalj.css">
...
<body>
    <div class="headerContainer">
        <div class="header">
            <div class="logga"> <img src="logga.png" height="50rem"></div>
            <div class="name">FilmTastic</div>
            <button class="buttonTicket">Tickets</button>
        </div>
    </div>
</body>
</html>